...
#         form = AddCCTVForm()
#         cctvs = requests.get("http://localhost:5000/cctv").json()
#         return render_template(
#             "manage_cctv.html",
#             title="Manage CCTV",
#             current_user=current_user,
...
# def delete_cctv(id):
#     status = requests.delete(f'http://localhost:5000/cctv/{id}')
#     if status == 204:
...
#     if id:
#         detector = requests.get(f'http://localhost:5000/detector/{id}').json()
#     else:
#         detector = None
#         form = DetectorForm()
#         title = "Add New Detector"

#     cameras = requests.get("http://localhost:5000/cctv").json()
